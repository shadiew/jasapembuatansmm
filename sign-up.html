                ...
                <div class="col-12 col-md-8 col-lg-6">
                    <div class="login-signup-wrap p-5 gray-light-bg rounded shadow">
                        <div class="login-signup-header text-center">
                            ...
                            <h5 class="mb-5">Create Your Account</h5>
                        </div>
                        <form class="login-signup-form">
                            ...
                            <div class="my-4">
                                <div class="custom-control custom-checkbox mb-3">
                                    ...
                                    <label class="custom-control-label small-text" for="check-terms">I agree to the <a href="terms-condition.html">Terms &amp; Conditions</a></label>
                                </div>
                            </div>
